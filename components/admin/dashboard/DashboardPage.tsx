    ...
    return (
        <div
            ...
            <div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
                <Card
                    className="" x-chunk="charts-01-chunk-0"
                >
            ...
            <div className="grid w-full flex-1 gap-6">
                ...
                <Card
                    className="" x-chunk="charts-01-chunk-3"
                >
                ...
                <Card
                    className="" x-chunk="charts-01-chunk-4"
                >
            ...
            <div className="grid w-full flex-1 gap-6">
                <Card
                    className="" x-chunk="charts-01-chunk-5"
                >
                ...
                <Card
                    className="" x-chunk="charts-01-chunk-6"
                >
                    <CardHeader className="p-4 pb-0">
                ...
                <Card
                    className="" x-chunk="charts-01-chunk-7"
                >
